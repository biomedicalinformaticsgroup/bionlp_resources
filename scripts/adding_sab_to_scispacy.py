...
df_abs = pickle.load(open(f'./abstracts/spacy_umls_df{n}.p', 'rb'))
...
pickle.dump(df_abs, open(f'./abstracts/spacy_umls_df{n}.p', "wb"))
print(f'Process complete for spacy_umls_df{n}')